...
terraform {
  backend "s3" {
    ...
    key    = "company-vpc-env-2/terraform.tfstate"
    region = "us-east-1"
    use_lockfile = true
    encrypt = true
  }
...
output "vpc_id" {
  ...
  value = module.company_modules.vpc_id
}

output "vpc_cidr" {
  description = "The CIDR block of the VPC"
  value = module.company_modules.vpc_cidr
}

output "public_subnet_cidr_block" {
  description = "The CIDR block of the public subnet"
  value = module.company_modules.public_subnet_cidr_block
}

output "private_subnet_cidr_block" {
  description = "The CIDR block of the private subnet"
  value = module.company_modules.private_subnet_cidr_block
}

output "instance_tenancy" {
  description = "The tenancy of the instances"
  value = module.company_modules.instance_tenancy
}

output "ami" {
  description = "The AMI to use for the instances"
  value = module.company_modules.ami
}

output "public_server_instance_type" {
  description = "The instance type for the public servers"
  value = module.company_modules.public_server_instance_type
}

output "private_server_instance_type" {
  description = "The instance type for the private servers"
  value = module.company_modules.private_server_instance_type
}

output "trusted_cidr" {
  description = "The trusted CIDR block for security group rules"
  value = module.company_modules.trusted_cidr
}

output "public_instance_public_ip" {
  description = "Public IP address of the public EC2 instance"
  value = module.company_modules.public_instance_public_ip
}